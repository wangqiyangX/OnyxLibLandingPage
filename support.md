...
- Using the built-in filtering options
- Sorting by date, book title, or other criteria
...
We recommend backing up your notes before uninstalling the app.
...
- If you use iCloud sync, your data is encrypted by Apple
- We do not collect or access your personal notes
...
2. **Check File Size**:
   - Very large files may take longer to import
   - Try importing smaller batches if you have many notes
...
3. **Reinstall the App**:
   - If problems persist, try deleting and reinstalling the app
   - **Important**: Make sure your data is backed up (iCloud or export) before reinstalling

### Widgets are not updating

1. **Check Widget Settings**:
   - Long press on the widget
   - Tap "Edit Widget" to configure it
...
- **Use Tags**: Create meaningful tags to categorize your notes
- **Regular Cleanup**: Periodically review and organize your notes
- **Backup Regularly**: Export your notes periodically as a backup

### Maximizing Performance

- **Limit Large Imports**: Import notes in smaller batches for better performance
- **Clear Cache**: If the app feels slow, try clearing cached data in settings
- **Keep Updated**: Always use the latest version of the app

### Using Widgets Effectively

- **Choose the Right Size**: Select widget sizes that fit your needs
- **Place Strategically**: Put widgets where you'll see them most
- **Customize Display**: Configure widgets to show the information most relevant to you
...
1. **In-App Feedback**: Use the feedback option in the app settings
2. **Email**: Send us an email at <wangqiyangx@gmail.com>
3. **Feature Requests**: Let us know what features you'd like to see
...
- **Technical Issues**: Within 24-48 hours
- **Critical Bugs**: We prioritize urgent issues and aim to respond within 24 hours
...
- **Storage**: Varies based on the number of notes (typically minimal)
- **Internet**: Optional (only required for iCloud sync)
